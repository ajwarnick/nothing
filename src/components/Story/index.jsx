        ...
        <div className={"story__Story "}>
            <div className='story__Story_Header'>
                <div className='story__Story_Header_Lines'>
                    <div className='story__Story_Header_Line done'></div>
                    <div className='story__Story_Header_Line active' style={{ "--timer": timer }}></div>
            ...
            <div className='story__Story_Footer'>
                <fieldset className='story__Story_Footer_fieldset'>
                    <label for="name">
                        <input className='story__Story_Footer_input' name="name" autocomplete="name" autocorrect="off" type="text" />
                    </label>  
                    <div className='story__Story_Footer_buttons'>
                        ...
                        <button className='story__Story_Footer_buttons_funny'>
                            <svg viewBox="0 0 16 16" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
